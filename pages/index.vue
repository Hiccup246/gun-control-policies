<template>
  ...
  <div>
    ...
    <GunPolicy name="2. Universal Background Checks">
      <p>
        Federal law requires background checks on all gun sales from licensed firearm dealers to ensure that gun
    ...
    <div>
      ...
      <ul>
        <li>
          <a href="https://www.everytown.org/">Everytown for gun safety</a>
          is the largest gun violence prevention orgnisation in America.
        </li>

        <li>
          <a href="https://giffords.org/">Giffords law center to prevent gun violence</a>
          is fighting to end the gun lobby's stranglehold on our political system.
        </li>

        <li>
          <a href="https://www.sandyhookpromise.org/">Sandy Hook Promise</a>
          is protecting America's children from gun violence in honor of the precious lives that were lost at Sandy Hook Elementary School.
        </li>

        <li>
          <a href="https://www.bradyunited.org/">The Brady Campaign</a>
          is an American nonprofit organization that advocates for gun control and against gun violence.
        </li>

        <li>
          <a href="https://publichealth.jhu.edu/departments/health-policy-and-management/research-and-practice/center-for-gun-violence-solutions">John Hopkins center for gun violence solutions</a>
          conducts rigorous research and use advocacy to implement evidence-based, equitable policies and programs that will prevent gun violence in our communities.
        </li>

        <li>
          <a href="https://supgv.org/">States United To Prevent Gun Violence</a>
          is unique in its commitment to independent state organizations, providing our 33 state affiliate affiliates with strategic support, operational backup, and opportunities for connection
        </li>
      </ul>
    </div>
  </div>
